...
labelstrain=[ones(150,1)*[1,0,0];ones(300,1)*[0,1,0];ones(400,1)*[0,0,1]];
labelstrain=vec2ind(labelstrain')';

labelsval=[ones(90,1)*[1,0,0];ones(180,1)*[0,1,0];ones(240,1)*[0,0,1]];
labelsval=vec2ind(labelsval')';

labelstest=[ones(60,1)*[1,0,0];ones(120,1)*[0,1,0];ones(160,1)*[0,0,1]];
...
labelsdata=[ones(300,1)*[1,0,0];ones(600,1)*[0,1,0];ones(800,1)*[0,0,1]];
labelsdata=vec2ind(labelsdata')';

model = svmtrain(labelstrain, traindata, '-s 1 -t 1 -d 2 -g 2 -r 1 -c 1 -n 0.1');
...
xlabel('Feature 1');
ylabel('Feature 2');
saveas(H,'DB_Nu_poly_nonlin.png');
close(H);
